...
func (s *mockSecurityCenterServer) CreateNotificationConfig(ctx context.Context, req *securitycenterpb.CreateNotificationConfigRequest) (*securitycenterpb.NotificationConfig, error) {
	md, _ := metadata.FromIncomingContext(ctx)
	if xg := md["x-goog-api-client"]; len(xg) == 0 || !strings.Contains(xg[0], "gl-go/") {
		return nil, fmt.Errorf("x-goog-api-client = %v, expected gl-go key", xg)
	}
	...
	return s.resps[0].(*securitycenterpb.NotificationConfig), nil
}

func (s *mockSecurityCenterServer) DeleteNotificationConfig(ctx context.Context, req *securitycenterpb.DeleteNotificationConfigRequest) (*emptypb.Empty, error) {
	md, _ := metadata.FromIncomingContext(ctx)
	if xg := md["x-goog-api-client"]; len(xg) == 0 || !strings.Contains(xg[0], "gl-go/") {
		return nil, fmt.Errorf("x-goog-api-client = %v, expected gl-go key", xg)
	}
...
func (s *mockSecurityCenterServer) GetNotificationConfig(ctx context.Context, req *securitycenterpb.GetNotificationConfigRequest) (*securitycenterpb.NotificationConfig, error) {
	md, _ := metadata.FromIncomingContext(ctx)
	if xg := md["x-goog-api-client"]; len(xg) == 0 || !strings.Contains(xg[0], "gl-go/") {
		return nil, fmt.Errorf("x-goog-api-client = %v, expected gl-go key", xg)
	}
...
func (s *mockSecurityCenterServer) ListNotificationConfigs(ctx context.Context, req *securitycenterpb.ListNotificationConfigsRequest) (*securitycenterpb.ListNotificationConfigsResponse, error) {
	md, _ := metadata.FromIncomingContext(ctx)
	if xg := md["x-goog-api-client"]; len(xg) == 0 || !strings.Contains(xg[0], "gl-go/") {
		return nil, fmt.Errorf("x-goog-api-client = %v, expected gl-go key", xg)
	}
	...
	return s.resps[0].(*securitycenterpb.ListNotificationConfigsResponse), nil
}
...
func (s *mockSecurityCenterServer) UpdateNotificationConfig(ctx context.Context, req *securitycenterpb.UpdateNotificationConfigRequest) (*securitycenterpb.NotificationConfig, error) {
	md, _ := metadata.FromIncomingContext(ctx)
	if xg := md["x-goog-api-client"]; len(xg) == 0 || !strings.Contains(xg[0], "gl-go/") {
		return nil, fmt.Errorf("x-goog-api-client = %v, expected gl-go key", xg)
	}
...
func TestSecurityCenterCreateNotificationConfig(t *testing.T) {
	var name string = "name3373707"
	var description string = "description-1724546052"
	var pubsubTopic string = "pubsubTopic-338126829"
	var serviceAccount string = "serviceAccount-1948028253"
	var expectedResponse = &securitycenterpb.NotificationConfig{
		Name:           name,
		Description:    description,
	...
	var formattedParent string = fmt.Sprintf("organizations/%s", "[ORGANIZATION]")
	var configId string = "configId-804450504"
	var notificationConfig *securitycenterpb.NotificationConfig = &securitycenterpb.NotificationConfig{}
	var request = &securitycenterpb.CreateNotificationConfigRequest{
		Parent:             formattedParent,
		ConfigId:           configId,
	...
	resp, err := c.CreateNotificationConfig(context.Background(), request)
...
func TestSecurityCenterCreateNotificationConfigError(t *testing.T) {
	errCode := codes.PermissionDenied
	mockSecurityCenter.err = gstatus.Error(errCode, "test error")
...
func TestSecurityCenterDeleteNotificationConfig(t *testing.T) {
	...
	var formattedName string = fmt.Sprintf("organizations/%s/notificationConfigs/%s", "[ORGANIZATION]", "[NOTIFICATION_CONFIG]")
	var request = &securitycenterpb.DeleteNotificationConfigRequest{
		Name: formattedName,
	}
	...
	err = c.DeleteNotificationConfig(context.Background(), request)
...
func TestSecurityCenterDeleteNotificationConfigError(t *testing.T) {
	errCode := codes.PermissionDenied
	mockSecurityCenter.err = gstatus.Error(errCode, "test error")
...
func TestSecurityCenterGetNotificationConfig(t *testing.T) {
	...
	var formattedName string = fmt.Sprintf("organizations/%s/notificationConfigs/%s", "[ORGANIZATION]", "[NOTIFICATION_CONFIG]")
	var request = &securitycenterpb.GetNotificationConfigRequest{
		Name: formattedName,
	}
	...
	resp, err := c.GetNotificationConfig(context.Background(), request)
...
func TestSecurityCenterGetNotificationConfigError(t *testing.T) {
	errCode := codes.PermissionDenied
	mockSecurityCenter.err = gstatus.Error(errCode, "test error")
...
func TestSecurityCenterListNotificationConfigs(t *testing.T) {
	var nextPageToken string = ""
	var notificationConfigsElement *securitycenterpb.NotificationConfig = &securitycenterpb.NotificationConfig{}
	var notificationConfigs = []*securitycenterpb.NotificationConfig{notificationConfigsElement}
	var expectedResponse = &securitycenterpb.ListNotificationConfigsResponse{
		NextPageToken:       nextPageToken,
	...
	var formattedParent string = fmt.Sprintf("organizations/%s", "[ORGANIZATION]")
	var request = &securitycenterpb.ListNotificationConfigsRequest{
		Parent: formattedParent,
	}
	...
	resp, err := c.ListNotificationConfigs(context.Background(), request).Next()
	...
	want := (interface{})(expectedResponse.NotificationConfigs[0])
	got := (interface{})(resp)
	var ok bool
...
func TestSecurityCenterListNotificationConfigsError(t *testing.T) {
	errCode := codes.PermissionDenied
	mockSecurityCenter.err = gstatus.Error(errCode, "test error")
...
func TestSecurityCenterUpdateNotificationConfig(t *testing.T) {
	var name string = "name3373707"
	var description string = "description-1724546052"
	var pubsubTopic string = "pubsubTopic-338126829"
	var serviceAccount string = "serviceAccount-1948028253"
	...
	var notificationConfig *securitycenterpb.NotificationConfig = &securitycenterpb.NotificationConfig{}
	var request = &securitycenterpb.UpdateNotificationConfigRequest{
		NotificationConfig: notificationConfig,
	}
	...
	resp, err := c.UpdateNotificationConfig(context.Background(), request)
...
func TestSecurityCenterUpdateNotificationConfigError(t *testing.T) {
	errCode := codes.PermissionDenied
	mockSecurityCenter.err = gstatus.Error(errCode, "test error")
