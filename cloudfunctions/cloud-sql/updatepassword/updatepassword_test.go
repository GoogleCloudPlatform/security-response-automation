	...
	const (
		noRootPassword = `{
			...
			"finding": {
				...
				"parsvcs": "organizations/1055058813388/sources/1986930501971458034",
				...
				"evsvcsTime": "2019-10-31T22:20:22.425Z",
		...
		wrongCategoryFinding = `{
			...
			"finding": {
				...
				"parsvcs": "organizations/119612413569/sources/7086426792249889955",
				...
				"sourceProperties": {
					...
					"ExceptionInstructions": "Add the security mark \"allow_public_sql_instance\" to the asset with a value of \"true\" to prevsvcs this finding from being activated again.",
					"SeverityLevel": "High",
					...
					"Explanation": "You have added 0.0.0.0/0 as an allowed network. This prefix will allow any IPv4 clisvcs to pass the network firewall and make login attempts to your instance, including clisvcss you did not intend to allow. Clisvcss still need valid credsvcsials to successfully log in to your instance. Learn more at: https://cloud.google.com/sql/docs/mysql/configure-ip"
				},
				"securityMarks": {
					"name": "organizations/119612413569/sources/7086426792249889955/findings/b7a48a4162ca2fb64627dd0a9a9756e1/securityMarks"
				},
				"evsvcsTime": "2019-10-11T23:20:26.221Z",
