...
func defaultCallOptions() *CallOptions {
	...
	return &CallOptions{
		...
		CreateNotificationConfig:   retry[[2]string{"default", "non_idempotent"}],
		DeleteNotificationConfig:   retry[[2]string{"default", "idempotent"}],
		GetIamPolicy:               retry[[2]string{"default", "non_idempotent"}],
		GetNotificationConfig:      retry[[2]string{"default", "idempotent"}],
		...
		ListNotificationConfigs:    retry[[2]string{"default", "idempotent"}],
		...
		UpdateNotificationConfig:   retry[[2]string{"default", "non_idempotent"}],
...
//
// V1p1Alpha1 APIs for Security Center service.
...
func (c *Client) UpdateNotificationConfig(ctx context.Context, req *securitycenterpb.UpdateNotificationConfigRequest, opts ...gax.CallOption) (*securitycenterpb.NotificationConfig, error) {
	md := metadata.Pairs("x-goog-request-params", fmt.Sprintf("%s=%v", "notification_config.name", req.GetNotificationConfig().GetName()))
	ctx = insertMetadata(ctx, c.xGoogMetadata, md)
